          ...
          <CardContent>
            ...
            >
              <div style={{ border: "2px solid black", padding: "1rem" }}>
                {" "}
                {/* Inline inner border to avoid any Tailwind parsing */}
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 gap-2 sm:gap-0">
                  <div className="flex items-center">
                    <div
                      className="w-12 sm:w-16 h-12 sm:h-16 rounded-full text-white flex items-center justify-center text-xs font-bold mr-2 sm:mr-4"
                  ...
                  <div className="text-right w-full sm:w-auto">
                    <div
                      style={{
                        ...
                        padding: "0.25rem sm:p-0.5rem",
                        marginBottom: "0.25rem sm:mb-0.5rem",
                      }}
                    >
                      {" "}
                      {/* Inline border */}
                ...
                <div className="flex flex-col sm:flex-row justify-between mb-4 sm:mb-6 gap-2 sm:gap-0">
                  <div className="text-xs sm:text-sm w-full sm:w-auto">
                    <p>
                      <strong>No. SIVR/PMPVL/24/0906/4654/2024</strong>
                    </p>
                    <p>
                  ...
                  >
                    ...
                    {formData.photoUrl ? (
                      ...
                      <div className="text-center text-xs pt-8 sm:pt-12">
                        Applicant Photo
                      </div>
                    )}
                  </div>
                ...
                <p className="text-xs sm:text-sm mb-2 sm:mb-4">
                  ...
                  <br />
                  Speedo business solutions pvt ltd
                </p>
                <p className="text-xs sm:text-sm mb-4 sm:mb-6 text-justify">
                  <strong>Subject:</strong> {formData.subject} residing at{" "}
                  {formData.address}, Thane- {formData.pincode},{" "}
                  {formData.state}
                </p>
                <p className="text-xs sm:text-sm mb-6 sm:mb-8 text-justify">
                  {formData.remarks}
                </p>
                <div className="text-center flex justify-center items-center flex-col mb-4 sm:mb-6">
                  ...
                  >
                    Refundable – ({Number(fee?.cardVerificationFee) + Number(fee?.hotelBookingFee) + Number(fee?.medicalKitFee) + Number(fee?.policeVerificationFee)}) The full amount will be returned to the
                ...
                <div className="flex flex-col sm:flex-row justify-between items-end gap-2 sm:gap-0">
                  ...
                  <div className="text-right text-xs sm:text-sm">
                    <p>
                      <strong>For Dy. Commissioner of Police</strong>
                    </p>
                    <p>
                      <strong>Special Branch,</strong>
                    </p>
                    <p>
                      <strong>Thane</strong>
                    </p>
                    <img
                      src={signature}
                      alt="Signature"
                      className="mt-2 w-32 h-8 inline-block"
                    />
                  </div>
                </div>
                <div
                  className="mt-6 sm:mt-8 text-xs text-center border-t pt-2 sm:pt-4"
                  style={{ borderTopColor: "black" }}
                >
                  {" "}
                  {/* Inline border-top if needed */}
                  This is a digitally signed document. To verify visit:
                  <br />
                  <span style={{ color: "#2563eb", fontWeight: "bold" }}>
                    https://mahapolice.maharashtra.gov.in
                  </span>
                </div>
              </div>
            </div>
