          ...
          <CardContent>
            ...
            >
              ...
              <div className="flex flex-col items-center text-center mb-6">
                ...
                <p 
                  className="text-sm font-medium mt-1 leading-tight uppercase"
              ...
              {/* Subject */}
              <div 
                className="font-semibold text-sm uppercase mb-6 pb-1"
                style={{ 
              ...
              {/* Body */}
              <div className="text-sm uppercase leading-relaxed" style={{ color: '#1f2937' }}> {/* gray-800 hex fallback */}
                <p className="mb-3">RESPECTED SIR,</p>
