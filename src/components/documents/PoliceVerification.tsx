  ...
  return (
    <div className="w-full bg-background min-h-screen p-8">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div style={{ border: '2px solid black', padding: '1.5rem' }}> {/* Inline inner border to avoid any Tailwind parsing */}
            ...
            <div className="flex justify-between mb-6">
              ...
              <div className="w-32 h-40 border-2 border-black overflow-hidden" style={{ borderColor: 'black' }}> {/* Ensure black is explicit */}
                {formData.photoUrl ? (
            ...
            <div className="mt-8 text-xs text-center border-t pt-4" style={{ borderTopColor: 'black' }}> {/* Inline border-top if needed */}
