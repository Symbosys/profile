...
//   const status = profile?.carVefificationStatus || '';
...
//       formData.append("cardVerification", cardFile);
...
//     } catch (err: any) {
//       const errorMessage = err.response?.data?.message || "Failed to upload card verification";
...
//           </svg>
//           <span className="font-medium">Verification Pending</span>: Awaiting administrator approval for card verification.
//         </div>
//       );
...
//             <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
//           </svg>
//           <span className="font-medium">Verification Rejected</span>: The submitted card verification was not approved.
//         </div>
//       );
...
//           </svg>
//           <span className="font-medium">Verification Approved</span>: The card verification has been successfully approved.
//         </div>
//       );
//     }
...
//           {!hasUploaded ? (
//             <>
//               <label className="block text-sm font-semibold text-gray-800 mb-2">Upload Card Verification</label>
//               <input
//                 type="file"
