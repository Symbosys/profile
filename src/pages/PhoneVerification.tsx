      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6 w-full">
        ...
        {profile && (
          <button
            ...
            className="w-full mt-4 px-6 py-3 rounded-lg bg-red-600 hover:bg-red-700 text-white font-semibold text-lg shadow-md transition-all duration-300 active:scale-95"
          >
            Use Another Email
          </button>
        )}
